    ...
    public sealed partial class DescriptionSectionPage : Page
    {
        ...
        /*private void PopulateRichTextBlock()
        {
            while (_descSection.ContentQueue.Count > 0)
            {
                ...
                {
                    case "Paragraph":
                        Paragraph para = _descSection.ContentQueue.Dequeue() as Paragraph;
                        if (para != null)
                        {
                            Windows.UI.Xaml.Documents.Paragraph paragraph = new Windows.UI.Xaml.Documents.Paragraph
                            {
                                FontSize = 15,
                            ...
                            var text = para.Text;
                            foreach (Link link in para.Links)
                            {
